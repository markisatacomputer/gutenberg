...
To learn all about contributing to the Gutenberg project, see the [Contributor Handbook](/docs/contributors/readme.md). The handbook includes all the details you need to get setup and start shaping the future of web publishing.
